...
export function ThemePanel() {
  ...
  const hslAdjustments = themeState.hslAdjustments || {
    hueShift: 0,
    saturationScale: 1,
    lightnessScale: 1,
  };
  ...
  const handleAdjustmentChange = (
    key: "hueShift" | "saturationScale" | "lightnessScale",
    value: number,
  ) => {
    setThemeState((prev) => ({
      ...prev,
  ...
  const sidebarVariables = useMemo(() => {
    return Object.keys(styles).filter((k) =>
      k.startsWith("sidebar"),
    ) as (keyof ThemeStyleProps)[];
  }, [styles]);
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={(e) =>
                handleAdjustmentChange("hueShift", parseInt(e.target.value))
              }
